...
<div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-talleres">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link disabled" href="../talleres/consultar.php">Consultar</a>
                            </li>
                            <li class="nav-item">
        ...
        <?php
			...
			$GradoE = $_POST['GradoE'];
			$FechaN = $_POST['FechaN'];
			$sql = mysqli_query($conn,"UPDATE usuario SET Nombre='$Nombre',  Domicilio ='$Domicilio', Ciudad='$Ciudad', CP='$CP', Genero ='$Genero', Ocupacion='$Ocupacion', GradoEstudios='$GradoE', Fecha_Nacimiento='$FechaN' where id=$id");
		if ($password != ""){
			$sql = mysqli_query($conn,"UPDATE usuario SET password='$password' where id=$id");
		}
            ...
            <center>
				<div class="card">
                  <div class="card-body">
					...
					<h4 class="card-title">USUARIO MODIFICADO CORRECTAMENTE</h4>
                    </form>
                  </div>
                </div>  
			</center>
