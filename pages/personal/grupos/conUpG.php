<?php
    ...
    $instruccion = "SELECT GA.idUsuario, U.nombre, U.apellidos, U.genero, U.escolaridad, U.Ocupacion FROM grupos_alumnos AS GA INNER JOIN usuarios AS U ON GA.idUsuario = U.idUsuario WHERE GA.idGrupo = ".$idGrupo;
