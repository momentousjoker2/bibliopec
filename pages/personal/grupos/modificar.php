              ...
              <form class="forms-sample" id='formulario'>
                <div class="form-row">
                  ...
                  <div class="col-md-2 mb-3">
                    <label for="validationDefault01">idTaller</label>
                    <input type="number" class="form-control" id="validationDefault01" name="idTaller" readonly
                      required>
                  </div>
                  <div class="col-md-4 mb-3">
                    <label for="validationDefault04">Taller</label>
                    <select class="custom-select" id="validationDefault02" name='Taller' readonly required>
                      <option selected disabled value="1"></option>
                    </select>
                  </div>
                </div>
                <div class="form-row">
                  <div class="col-md-5 mb-3">
                    ...
                    <input type="text" class="form-control" id="validationDefault03" name='Escuela' required>
                  </div>
                  <div class="col-md-6 mb-3">
                    <label for="validationDefault01">Nombre del encargado</label>
                    <input type="text" class="form-control" id="validationDefault04" name='Encargado' required>
                  </div>
                </div>
...
<script>
  ...
  var sl = document.getElementById('validationDefault02');
  function talleres() {
    fetch('mTalleres.php', {
      method: 'GET'
    }).then(response => response.text())
  ...
  slG.addEventListener('input', function (e) {
    ...
    fetch('comple.php', {
      ...
      .then(data => {
          ...
          sl.value= arr[0];
          let idTaller = document.getElementById('validationDefault01');
          idTaller.value = arr[0];
          let Escuela = document.getElementById('validationDefault03');
          Escuela.value = arr[1];
          let encargado = document.getElementById('validationDefault04');
          encargado.value = arr[2];
      });
  });
