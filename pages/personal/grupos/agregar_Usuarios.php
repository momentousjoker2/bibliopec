        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="ui-grupos">
            <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item">
                <a class="nav-link disabled" href="agregar_Usuarios.php">Agregar Usuarios</a>
              </li>
            </ul>
          </div>
        </li>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="card">
            <div class="card-body">
              <center>
                <h4 class="card-title">AGREGAR USUARIO A GRUPO</h4>
                <p class="card-description">Ingrese datos</p>
              </center>
              <form class="forms-sample" id='formulario'>
                <div class="form-row">
                  <div class="col-md-2 mb-3">
                    <label for="validationDefault00">Grupo</label>
                    <select class="custom-select" id="validationDefault00" name='idGrupo' required>
                      <option selected disabled value="1"></option>
                    </select>
                  </div>
                  <div class="col-md-3 mb-3">
                    <label for="validationDefault01">idUsuario</label>
                    <input type="text" class="form-control" id="validationDefault01" name='idUsuario' readonly required>
                  </div>
                  <div class="col-md-5 mb-3">
                    <label for="validationDefault04">Nombre *</label>
                    <select class="custom-select" id="validationDefault04" name='Usuario' required>
                ...
                <div class="form-row"> 
                  <div class="col-md-6 mb-3">
                    <label for="validationDefault03">Nombre del Tutor *</label>
                    <input type="text" class="form-control" id="validationDefault03" name='Tutor' required>
                  </div>
                  <div class="col-md-3 mb-3">
                    <label for="validationDefault02">Permiso *</label>
                    <select class="custom-select" id="validationDefault02" name='Estado' required>
                      <option selected disabled value=""></option>
...
<script>
      var slU = document.getElementById('validationDefault04');
      var slG = document.getElementById('validationDefault00');
      function grupos() {
        fetch('mGrupo.php',{
      method: 'GET'
      ...
      usuarios();
      grupos()
      slU.addEventListener('input',function(e) {
        let idUsuario = document.getElementById('validationDefault01');
        let selectedOption = this.options[slU.selectedIndex];
        idUsuario.value = selectedOption.value;
      });
  ...
  .then(data =>{
      alert(data);
      let esc = document.getElementById('validationDefault03');
      esc.value ="";
  });
    });
</script>
